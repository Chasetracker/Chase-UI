        ...
        <div className='flex flex-col w-full justify-center min-h-screen items-center pb-10'>
            <nav className='flex py-5 px-20 w-full justify-between items-center h-[100px] bg-white fixed z-[99999] top-0 shadow-md'>
                ...
                <div className='flex space-x-5'>
                    <Button btnValue='Log In' className='text-[##667085] border-[1px] rounded-lg h-[45px] w-[100px] hover:bg-[#da7359] hover:text-[white]' />
            ...
            <Link href='https://accounts.google.com.ng/' className={`w-[450px] -mt-14 px-10 `} target='_blank'>
                <button
                    type="submit"
                    className={`w-full border-[1px] flex border-[#D0D5DD] items-center justify-center  text-[#314155] py-2 px-4 rounded-md hover:bg-purple5 text-sm hover:bg-[#da7359] hover:text-white`}
                >
            ...
            <div className={`flex justify-center text-[#647187] font-[600] w-[450px] mt-8 space-x-5 px-10  `}>
                <h5>Don&apos;t have an account?</h5>
                <Link href="/auth/signUp" className={`text-primary hover:text-[17px] `}>
                    Sign Up
                </Link>
            </div>
