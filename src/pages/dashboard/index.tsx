            ...
            {!token ? <h1 className='p-4 text-2xl flex justify-center items-start text-[red]'>Redircting to login page!!!</h1> :
                <DashboardLayout>
                    ...
                    <main className={`relative  h-full px-10 pt-10`}>
                        ...
                        <section className={`flex flex-col w-full overflow-y-auto space-y-3 ${isOpened ? ' opacity-[0.3]' : ''}`}>
                            ...
                            <div className='w-full'>
                                <TransactionList totalSalesAmount={0} customerName={''} status={''} transactionsPerPage={3} />
                            </div>
